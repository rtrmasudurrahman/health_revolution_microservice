...
// import { validateEmailVerification } from "@/lib/validationService";
import { findUserByEmail, updateUserStatus } from "@/lib/userService";
import {
...
const verifyEmail = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    await updateVerificationCodeStatus(verificationCode.id);
